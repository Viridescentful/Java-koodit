...
for (let picture of picArray) {
    ...
    picturearticle.classList.add('card')

    const header2 = document.createElement('h2')
    header2.innerHTML = picture.title
    picturearticle.appendChild(header2)

    const figure = document.createElement('figure')
    picturearticle.appendChild(figure)
    ...
    figcaption.innerHTML = picture.caption
    figure.appendChild(figcaption)

    const p = document.createElement('p')
    p.innerHTML = picture.description
    picturearticle.appendChild(p)

    document.querySelector('#pictures').append(picturearticle);
}
